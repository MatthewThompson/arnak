...
mod tests {
    ...
    use crate::{
        ...
        MarketplaceListing, PlayerAge, PlayerCount, Price, RankBayesAverage, RankValue,
        RatingComment, RatingCommentPage, SuggestedPlayerAge, SuggestedPlayerAgePoll,
        SuggestedPlayerCount, SuggestedPlayerCountPoll, User, Video, VideoCategory,
    };
                ...
                stats: GameStats {
                    ...
                    ranks: vec![
                        GameFamilyRank {
                            ...
                            bayesian_average: RankBayesAverage::Ranked(7.89555),
                        },
                        GameFamilyRank {
                            ...
                            bayesian_average: RankBayesAverage::Ranked(7.89048),
                        },
                    ],
                    users_owned: 68393,
                    users_trading: 456,
                ...
                stats: GameStats {
                    ...
                    ranks: vec![
                        GameFamilyRank {
                            ...
                            bayesian_average: RankBayesAverage::NotRanked,
                        },
                        GameFamilyRank {
                            game_family_type: GameFamilyType::Family,
                            id: 5497,
                ...
                stats: GameStats {
                    ...
                    ranks: vec![
                        GameFamilyRank {
                            ...
                            friendly_name: "Board Game Rank".to_owned(),
                            value: RankValue::NotRanked,
                            bayesian_average: RankBayesAverage::Ranked(7.92384),
                        },
                        GameFamilyRank {
                            game_family_type: GameFamilyType::Family,
                            id: 5497,
                            ...
                            friendly_name: "Strategy Game Rank".to_owned(),
                            value: RankValue::NotRanked,
                            bayesian_average: RankBayesAverage::Ranked(8.06708),
                        },
                    ],
                    users_owned: 26790,
                    users_trading: 119,
